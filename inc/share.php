...
function share_box($content='',$forced=false) {
	...
	$content .= '<a class="share-link linkedin" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url='. $post_url .'&title='. $post_title .'&source='. get_home_url() .'"><span class="sr-only">Linkedin</span></a>';
	$content .= '</div>';
